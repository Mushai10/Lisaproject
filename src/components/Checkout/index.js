...
function Checkout({ checkoutItems }) {
    ...
    const makePayment = async (e) => {
        ...
        const checkoutTok = await commerce.checkout.generateToken(commerce.cart.id, { type: 'cart' })
            .then((checkout) => console.log(checkout.id))

        await commerce.checkout.capture(checkoutTok, {
            customer: {
                email: form_values['billing-email'],
                firstname: form_values['biling-firstname'],
                lastname: form_values['billing-lastname'],
                phone: form_values['billing-phone']
            },
            billing: {
                country: form_values['billing-country'],
                county_state: form_values['billing-state'],
                street: form_values['billing-street'],
                street_2: form_values['billing-street2'],
                town_city: form_values['billing-town'],
                postal_zip_code: form_values['billing-zip-code']
            },
            payment: {
                gateway: 'paypal',
            },
    ...
    if (checkingOut) {
        return <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-[40px] text-primary animate-spin">
            <BiLoaderAlt />
        </div>
    }
    return (
                                ...
                                <div className="grid grid-cols-12 lg:gap-x-[25px] max-md:gap-y-[50px]">
                                    <div className="lg:col-span-7 col-span-12">
                                        <div className="billing">
                                            ...
                                            <form id="checkout-form" className="billing-form" onSubmit={makePayment}>
                                    ...
                                    <div className="lg:col-span-5 col-span-12">
                                        <div className="order-info">
                                            ...
                                            <div className="payment-btn-wrap pt-[35px]">
                                                ...
                                                // onClick={async () => {
                                                //     console.log("Payment sent through!!")
                                                //     await makePayment()
                                                // }}
                                                >
                                                    {
