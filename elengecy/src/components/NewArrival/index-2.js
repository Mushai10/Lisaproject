            ...
            <div className="container-fluid md:px-[100px] px-[15px]">
                <div className="lg:columns-2 columns-1 mx-auto lg:gap-x-[25px] lg:space-y-[100px] md:space-y-[80px] space-y-[50px]">
                    {newArrivalTwo[0]?.newArrivalItemsTwo?.map(
                        (newArrivalItemTwo) => {
                            console.log("ITM 2: ", newArrivalItemTwo)
                            console.log("Products", products.map(itm=> itm.id))
                            const x = `/images/products-commerce/${products.find(
                                (item) =>
                                    item.id ===
                            ...
                            return (
                                ...
                                >
                                   {false && <div className="product-img overflow-hidden group">
                                        <Link
                                        ...
                                        >
                                            <img
                                                ...
                                                // src={`/images/products-commerce/${products.find(
                                                //     (item) =>
                                                //         item.id ===
                                                //         newArrivalItemTwo.id
                                                // )?.slug
